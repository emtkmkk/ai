...
export const skills: Skill[] = [
    ...
    { name: `粘り強い`, short: "粘", desc: `体力が減るほど受けるダメージを軽減します`, info: `ダメージカット20%×(減少HP割合)を得る 最大90%`, effect: { tenacious: 0.2 } },
    { name: `高速RPG`, short: "速", desc: `1回のRPGでお互いに2回行動します`, info: `1回のコマンドで2ターン進行する レイド時は、${serifs.rpg.status.atk}+10%`, effect: { plusActionX: 1 } },
    { name: `1時間先取りRPG`, short: "先", desc: `1時間早くRPGをプレイする事が出来ます`, info: `1時間早くRPGプレイ可能 ステータス+5%`, effect: { atkUp: 0.05, defUp: 0.05, rpgTime: -1 } },
    ...
    { name: `${serifs.rpg.dmg.give}${serifs.rpg.status.rndM}4`, short: "４", desc: `乱数幅が20~180 -> 60~160になります`, info: `乱数幅 20~180 -> 60~160 (%) 期待値 110% 乱数系と重複しない`, effect: { atkRndMin: 0.4, atkRndMax: -0.2 }, unique: "rnd" },
    { name: `${serifs.rpg.dmg.give}${serifs.rpg.status.rndM}5`, short: "５", desc: `乱数幅が20~180 -> 90~130になります`, info: `乱数幅 20~180 -> 90~130 (%) 期待値 110% 乱数系と重複しない`, effect: { atkRndMin: 0.7, atkRndMax: -0.5 }, unique: "rnd" },
    { name: `${serifs.rpg.dmg.give}${serifs.rpg.status.rndP}`, short: "乱", desc: `乱数幅が20~180 -> 5~230になります クリティカル率も上がります`, info: `乱数幅 20~180 -> 5~230 (%) 期待値 115% クリティカル率+2% 乱数系と重複しない`, effect: { atkRndMin: -0.15, atkRndMax: 0.5, critUpFixed: 0.02 }, unique: "rnd" },
    ...
    { name: `準備を怠らない`, short: "備", desc: `ターン1にて、必ず良い効果がある武器か防具を装備します`, info: `ターン1装備率+100% ターン1悪アイテム率-100% アイテム装備率-15% 重複しない`, effect: { firstTurnItem: 1, firstTurnMindMinusAvoid: 1, itemEquip: -0.15 }, unique: "firstTurnItem" },
    { name: `道具大好き`, short: "道", desc: `道具の使用率が上がります`, info: `アイテム装備率+40%`, effect: { itemEquip: 0.4 } },
    { name: `道具の扱いが上手い`, short: "扱", desc: `道具の効果量が上がります`, info: `アイテム効果量+40% アイテム悪効果軽減+40%`, effect: { itemBoost: 0.4 } },
    { name: `武器が大好き`, short: "武", desc: `武器を装備しやすくなり、武器の効果量が上がります`, info: `武器装備率2倍 武器効果量+60% 種類大好き系と重複しない`, effect: { weaponSelect: 1, weaponBoost: 0.6 }, unique: "itemSelect" },
    { name: `防具が大好き`, short: "防", desc: `防具を装備しやすくなり、防具の効果量が上がります`, info: `防具装備率2倍 防具効果量+60% 種類大好き系と重複しない`, effect: { armorSelect: 1, armorBoost: 0.6 }, unique: "itemSelect" },
    { name: `食いしんぼう`, short: "食", desc: `食べ物を食べやすくなり、食べ物の効果量が上がります`, info: `食べ物使用率2倍 食べ物効果量+60% 毒食べ物ダメージ-60% 種類大好き系と重複しない`, effect: { foodSelect: 1, foodBoost: 0.6, poisonResist: 0.6 }, unique: "itemSelect" },
    { name: `なんでも口に入れない`, short: "捨", desc: `良くないものを食べなくなることがあります`, info: `毒食べ物を50%で捨てる 100%以上になると悪アイテム率減少に変換`, effect: { poisonAvoid: 0.5 } },
    { name: `道具の選択が上手い`, short: "選", desc: `道具の効果量がすこし上がり、悪いアイテムを選びにくくなります`, info: `道具効果量+15% 悪アイテム率-15%`, effect: { itemBoost: 0.15, mindMinusAvoid: 0.15 } },
    { name: `お腹が空いてから食べる`, short: "空", desc: `体力が減ったら食べ物を食べやすくなり、食べ物の効果量が少し上がります`, info: `残HP%で食べ物を食べるようになる 食べ物効果量+20% 毒食べ物ダメージ-20%`, effect: { lowHpFood: 1, foodBoost: 0.2, poisonResist: 0.2 }, unique: "lowHpFood" },
    { name: `たまにたくさん成長`, short: "成", desc: `たまにステータスが多く増加します ★変更不可`, info: `2Lv毎になにかのステータス+1 ★変更不可（変更してもステータスは残るため）`, effect: { statusBonus: 1 }, unique: "status", cantReroll: true },
    { name: `連続攻撃完遂率上昇`, short: "遂", desc: `連続攻撃を相手に止められにくくなります`, info: `連続攻撃中断率-30% 効果がない場合、${serifs.rpg.status.atk}+10%`, effect: { abortDown: 0.3 } },
    ...
    { name: `敵のクリティカル性能減少`, short: "守", desc: `相手のクリティカル率とクリティカルダメージが減少します`, info: `敵のクリティカル率-30% 敵のクリティカルダメージ-30% レイド時は、${serifs.rpg.status.def}+10%`, effect: { enemyCritDown: 0.3, enemyCritDmgDown: 0.3 } },
    { name: `負けた時、しっかり反省`, short: "省", desc: `敗北時のボーナスが上昇します ★変更不可`, info: `敗北毎にステータス+2 ★変更不可（変更してもステータスは残るため）`, effect: { loseBonus: 1 }, unique: "loseBonus", cantReroll: true },
...
export function getSkillsShortName(data: { items?: ShopItem[], skills: Skill[] }): { skills?: string | undefined, amulet?: string | undefined } {
    const dataSkills = data.skills?.length ? "[" + data.skills.map((x) => (x.find((y) => x.name === y.name) ?? x).short).join("") + "]" : undefined
