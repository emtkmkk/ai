...
export const skills: Skill[] = [
	...
	{ name: `炎属性妖術`, effect: { fire: 0.1 } },
	{ name: `氷属性妖術`, effect: { ice: 0.1 } },
	{ name: `雷属性妖術`, effect: { thunder: 0.2 } },
	{ name: `風属性妖術`, effect: { spdUp: 0.1 } },
	{ name: `土属性妖術`, effect: { dart: 0.2 } },
	{ name: `光属性妖術`, effect: { light: 0.2 } },
	{ name: `闇属性妖術`, effect: { dark: 0.1 } },
	{ name: `毒属性妖術`, effect: { weak: 0.05 } },
