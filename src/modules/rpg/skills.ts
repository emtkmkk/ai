...
export const skills: Skill[] = [
    ...
    { name: `武器が大好き`, effect: { weaponSelect: 1, weaponBoost: 0.6 }, unique: "itemSelect" },
    { name: `防具が大好き`, effect: { armorSelect: 1, armorBoost: 0.6 }, unique: "itemSelect" },
    { name: `食いしんぼう`, effect: { foodSelect: 1, foodBoost: 0.6, poisonResist: 0.6 }, unique: "itemSelect" },
    { name: `なんでも口に入れない`, effect: { poisonAvoid: 0.5 } },
    { name: `道具の選択が上手い`, effect: { mindMinusAvoid: 0.15 } },
    { name: `お腹が空いてから食べる`, effect: { lowHpFood: 1, foodBoost: 0.2, poisonResist: 0.2 }, unique: "lowHpFood" },
