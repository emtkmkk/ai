...
export const shop2Items: ShopItem[] = [
  ...
  {
    name: `苦労のお守り`,
    limit: (data) => data.allClear && data.streak > 0,
    price: 1,
  ...
  {
    name: '幸運の力の種',
    limit: (data) => (10 - (data.atk % 10) + 7) % 10 !== 0,
    desc: '購入時、パワーの下1桁が7になるように防御から移動',
    price: (data) => (10 - (data.atk % 10) + 7) % 10,
    type: 'item',
    effect: (data) => {
      data.def = (data.def ?? 0) - ((10 - (data.atk % 10) + 7) % 10);
      data.atk = (data.atk ?? 0) + ((10 - (data.atk % 10) + 7) % 10);
    },
    infinite: true,
    always: true,
  },
  ...
  },
  {
    ...
    effect: (data) => {
      data.atk = Math.round(
        (data.atk ?? 0) + Math.round((data.def ?? 0) * 0.3),
      );
      data.def = Math.round(
        (data.def ?? 0) - Math.round((data.def ?? 0) * 0.3),
      );
    },
    infinite: true,
    always: true,
  ...
  {
    name: '幸運の守りの種',
    limit: (data) => (10 - (data.def % 10) + 7) % 10 !== 0,
    desc: '購入時、防御の下1桁が7になるようにパワーから移動',
    price: (data) => (10 - (data.def % 10) + 7) % 10,
    type: 'item',
    effect: (data) => {
  ...
  },
  {
    ...
    effect: (data) => {
      ...
      data.atk = Math.round((data.atk ?? 0) - Math.round((data.atk ?? 0) / 10));
    },
    infinite: true,
    always: true,
  },
  {
    ...
    effect: (data) => {
      data.def = Math.round(
        (data.def ?? 0) + Math.round((data.atk ?? 0) * 0.3),
      );
      data.atk = Math.round(
        (data.atk ?? 0) - Math.round((data.atk ?? 0) * 0.3),
      );
    },
    infinite: true,
    always: true,
  },
  {
    ...
    orb: true,
    type: 'item',
    effect: (data) => (data.atkMedal = (data.atkMedal ?? 0) + 1),
    infinite: true,
    always: true,
  },
  {
    ...
    orb: true,
    type: 'item',
    effect: (data) => (data.defMedal = (data.defMedal ?? 0) + 1),
    infinite: true,
    always: true,
  },
  {
  ...
  },
  {
    ...
    orb: true,
    type: 'item',
    effect: (data) => (data.itemMedal = (data.itemMedal ?? 0) + 1),
    infinite: true,
    always: true,
  },
  {
  ...
  {
    name: `決めポーズの穢根くんのチェキ`,
    limit: (data) => (data.jar ?? 0) === 1 && data.shopExp > 400,
    price: 400,
  ...
  },
  {
    ...
    limit: (data) => (data.jar ?? 0) === 2 && data.shopExp > 1000,
    price: 600,
  ...
  {
    name: `隠し撮り穢根くんのチェキ`,
    limit: (data) => (data.jar ?? 0) === 3 && data.shopExp > 1800,
    price: 800,
  ...
  {
    name: `寝顔の穢根くんのチェキ`,
    limit: (data) => (data.jar ?? 0) === 4 && data.shopExp > 2800,
    price: 1000,
  ...
  {
    name: `女装した穢根くんのチェキ`,
    limit: (data) => (data.jar ?? 0) === 5 && data.shopExp > 4000,
    price: 1200,
  ...
  {
    name: `激レア穢根くんのチェキ`,
    limit: (data) => (data.jar ?? 0) >= 6 && data.shopExp > 5400,
...
export const shop2Reply = async (module: rpg, ai: 藍, msg: Message) => {
  ...
  data.shop2Items.forEach((x, index) => {
    if (Array.isArray(x))
      data.shop2Items[index] = x.map((x) => x.replace('undefined', ''));
    if (!x.includes('&') || !x.includes('のお守り')) return;
    data.shop2Items[index] = x.replace('のお守り', '').split('&');
  });

  const _shopItems = (data.shop2Items as (string | string[])[])
    .map((x) =>
      Array.isArray(x)
        ? mergeSkillAmulet(
            ai,
        ...
        : (shop2Items.find((y) => x === y.name) ?? undefined),
    )
