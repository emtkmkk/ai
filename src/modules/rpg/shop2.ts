...
const canBankItems: ShopItem[] = [
	...
	{ name: `修繕の札`, price: 50, limit: (data) => enhanceCount(data) >= 9, desc: `持っているとお守りが耐久が減る代わりにもこコインを減少させます 耐久1につき減少するコイン数はお守りの購入額/耐久です`, type: "token", effect: { autoRepair: true }, always: true } as TokenItem,
