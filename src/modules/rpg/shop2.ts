...
export const shop2Items: ShopItem[] = [
	...
	{ name: "もこコイン(35枚)", limit: (data) => (data.atkMedal ?? 0) + (data.defMedal ?? 0) + (data.itemMedal ?? 0) >= 30, desc: "ショップでのアイテム購入などに使用できる通貨です", price: 20, orb: true, type: "item", effect: (data) => data.coin = (data.coin ?? 0) + 35, infinite: true, always: true },
