...
export const shopItems: ShopItem[] = [
    ...
    { name: `交通安全のお守り`, price: 30, desc: `持っているとターン1で30%ダメージカット 耐久10 使用時耐久減少`, type: "amulet", effect: { firstTurnResist: 0.3 }, durability: 10, short: "安", isUsed: (data) => data.count === 1 } as AmuletItem,
    { name: `高級交通安全のお守り`, price: 99, desc: `持っているとターン1で70%ダメージカット 耐久10 使用時耐久減少`, type: "amulet", effect: { firstTurnResist: 0.7 }, durability: 10, short: "S安", isUsed: (data) => data.count === 1 } as AmuletItem,
