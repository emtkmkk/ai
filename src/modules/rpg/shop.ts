...
export const shopItems: ShopItem[] = [
	...
	{ name: `わかばのお守り`, limit: (data) => data.skills?.length < 4, price: 10, desc: `所持しているスキル数が少ないほどステータスが上がります 耐久20`, type: "amulet", effect: { beginner: 1 }, durability: 20, short: "🔰", isUsed: (data) => true } as AmuletItem,
