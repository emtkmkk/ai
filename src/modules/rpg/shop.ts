...
export const shopItems: ShopItem[] = [
	...
	{ name: `超越のお守り`, price: 10, desc: `レイド時、体力を1残し、残りの全てをバリアに変換する 耐久10 レイドでの使用時耐久減少`, type: "amulet", effect: { transcendence: 1 }, durability: 10, short: "超越", isUsed: (data) => data.raid } as AmuletItem,
