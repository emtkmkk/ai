...
export const shopItems: ShopItem[] = [
	...
	{ name: `わかばのお守り`, limit: (data) => data.skills?.length < 4, price: (data) => Math.max(Math.min(data.coin, 10), 1), desc: `所持しているスキル数が少ないほどステータスが上がります 耐久20`, type: "amulet", effect: { beginner: 0.05 }, durability: 20, short: "🔰", isUsed: (data) => true } as AmuletItem,
