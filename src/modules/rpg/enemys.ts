...
export const enemys: Enemy[] = [
	...
	},
	{
		...
		losemsg: '阨ちゃんは疲れて倒れてしまった…',
		endingmsg: ':shiromaru_dotto:は:kochi_shiromaru_drop:と一緒にどこかに逃げ去った！',
		atk: 1,
		def: 1.5,
		atkx: 4,
		defx: 4,
	...
	},
	{
		name: ':kochisan:',
		dname: ':kochisan:',
		limit: (data) => (data.winCount ?? 0) >= 4 && (data.streak ?? 0) >= 4 && data.clearEnemy.includes(':kochi_shiromaru_drop:'),
	...
	},
	{
		...
		limit: (data, friend) => (data.winCount ?? 0) >= 13 && (data.streak ?? 0) >= 13 && data.clearEnemy.includes(':aichan8:'),
		msg: ':ai_minazuki_buged:縺ｻ繧薙→縺??繧上◆縺',
		short: ':ai_minazuki_buged:縺ｨ縺ｾ縺悶ｊ縺ゅ＞',
		mark: '☆',
		mark2: '★',
		lToR: false,
		atkmsg: (dmg) => `阨ちゃんの蝠上＞縺九￠！\n:aine_youshou:の精神に${dmg}ポイントのダメージ！`,
		defmsg: (dmg) => `:ai_minazuki_buged:縺阪％縺医ｋ縺ｾ縺吶°！\n阨ちゃんの精神に${dmg}ポイントのダメージ！`,
		abortmsg: ':ai_minazuki_buged:縺ｩ縺?＠縺ｦ縺ｨ縺?≧縺ｨ髦ｨ縺｡繧?ｓ縺ｯ蜍輔￠縺ｪ縺上↑縺｣縺！',
		winmsg: '::ai_minazuki_buged:縺ゅｊ縺後→縺?→險?縺｣縺ｦ蜴ｻ縺｣縺ｦ縺?▲縺！',
		losemsg: '阨ちゃんは目の前が真っ暗になった…',
		endingmsg: ':ai_minazuki_buged:は微笑みながらまるで夢か幻のように消えていった…',
		atk: 13,
		def: 13,
		maxdmg: 1.3,
		atkx: 13,
