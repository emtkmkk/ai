...
export const rpgItems: Item[] = [
    ...
    { name: "ぷるぷるごま油", type: "poison", effect: 70, mind: -40 },
    { name: "土木学会田中賞を受賞した押し入れの奥から出てきた謎の生き物", type: "armor", effect: 60, mind: -30 },
    { name: "ときどき分裂するビーフジャーキー", type: "medicine", effect: 65, mind: 50 },
    ...
    { name: "うますぎないカレー無しカレーパン", type: "poison", effect: 60, mind: -40 },
    { name: "無機質な永久機関", type: "armor", effect: 75, mind: 50 },
    { name: "人類の技術を結集して作ったかぼちゃ", type: "medicine", effect: 80, mind: 70 },
    ...
    { name: "カビの生えた壺", type: "poison", effect: 85, mind: -70 },
    ...
    { name: "甘すぎるタピオカ", type: "poison", effect: 60, mind: -30 },
    ...
    { name: "ナノサイズきのこ", type: "medicine", effect: 65, mind: 50 },
    ...
    { name: "霧散するクリーム無しクリームパン", type: "poison", effect: 75, mind: -50 },
    ...
    { name: "滅びの液体", type: "poison", effect: 90, mind: -80 },
    ...
    { name: "カレー無しカレーパンまたは幻の食パンの耳47年分", type: "medicine", effect: 90, mind: 80 },
    ...
    { name: "ピンクのズッキーニ", type: "medicine", effect: 80, mind: 70 },
    ...
    { name: "シルクタッチのエンチャントが付与されたオレオ", type: "medicine", effect: 75, mind: 60 },
    ...
    { name: "プリンに擬態した次世代[R]で所持金MAX の秘技コード", type: "medicine", effect: 90, mind: 70 },
    { name: "帯電C18H27NO3", type: "poison", effect: 90, mind: -80 },
    ...
    { name: "甘すぎるパンチ", type: "poison", effect: 75, mind: -60 },
    ...
    { name: "クッキーに見せかけて天然ダークマター", type: "poison", effect: 95, mind: -100 },
    { name: "2027年製UFO", type: "armor", effect: 85, mind: 90 },
    { name: "チョコ入り狂う狂う狂うラップ", type: "poison", effect: 85, mind: -70 },
    ...
    { name: "呪われた卵かけご飯", type: "poison", effect: 80, mind: -80 },
    { name: "コンソメの押し入れの奥から出てきた謎の生き物", type: "armor", effect: 5, mind: -50 },
    { name: "チョコレートコーティング全白皆伝", type: "medicine", effect: 75, mind: 60 },
    ...
    { name: "カビの生えた電動マッサージ機", type: "poison", effect: 90, mind: -90 },
    ...
    { name: "合法エナジードリンク", type: "medicine", effect: 80, mind: 70 },
