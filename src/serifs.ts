...
*/
	...
	reversi: {
		...
		/** 段階的開放中で対局できないとき（n日後に開放見込み） */
		notAvailableInDays: (days: number) => `あなたとはまだリバーシでは遊べないみたいです。${days}日後に遊べるようになるので、また試してみてね！`,

		/** 管理者未プレイかつ好感度200以上のとき */
		notAvailableWithWait: 'あなたとはまだリバーシでは遊べないみたいです。時間をおいて、また試してみてね！',
	 ...
	 */
        kazutori: {
                ...
                banned: '不正な行為でゲームを有利に進めようとされた可能性が高いため、あなたは参加を停止されています。',
