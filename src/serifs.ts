  ...
  rpg: {
    ...
    oneMore: {
      ...
      buyQuestion: (num, coin) =>
        `\n皆尽村商品券を${num}枚使用すると、もう1回おかわりRPGをプレイできる裏技があるのじゃ！\n\n消費してわらわと遊ぶかの？（所持商品券枚数: ${coin}）\n\n「はい」または「いいえ」で返信して欲しいのじゃ！`,
      buyComp: `\nくふふ！おかわりRPGがプレイ可能になったのじゃ！\nもう一度おかわりRPGを試してみて欲しいのじゃ！`,
      autoBuy: (coin) =>
        `おかわりRPGのプレイ権利を自動購入したのじゃ！\n（残り商品券枚数: ${coin}）`,
    },
